...
- generic [ref=f6e2]:
  - generic [ref=f6e4]:
    ...
    - generic [ref=f6e6]:
      - generic [ref=f6e7]:
        - link "Skip to content" [ref=f6e8]:
          - /url: "#checkout-main"
        - generic [ref=f6e9]:
          - banner [ref=f6e10]:
            - generic [ref=f6e15]:
              - link "Sauce Demo Navigate to Online Store" [ref=f6e17]:
                      ...
                      - region "Contact" [ref=f6e34]:
                        - generic [ref=f6e38]:
                          - generic [ref=f6e39]:
                            ...
                            - link "Sign in" [ref=f6e41]:
                              - /url: https://sauce-demo.myshopify.com/account/login?checkout_url=%2Fcheckouts%2Fcn%2FhWNHClJtXOAqi9FDA2bQK54O%2Fen-in%3F_r%3DAQABzRN3R9NvsuOhcPkTjtcBcBQY58rquJ1UIsqpcc3h1jk%26company_location_id%26locale%3Den-IN
                          - generic [ref=f6e43]:
                            - generic [ref=f6e49]:
                              - generic: Email
                          ...
                          - generic [ref=f6e75]:
                            - generic [ref=f6e79]:
                              ...
                              - generic [ref=f6e147]:
                                ...
                                - textbox [aria-hidden] [ref=f6e152]: Bangalore
                                - textbox [aria-hidden] [ref=f6e153]: IN
                                - textbox [aria-hidden] [ref=f6e154]: KA
                                - textbox [aria-hidden] [ref=f6e155]: KA
                                - textbox [aria-hidden] [ref=f6e156]: KA
                                - textbox [aria-hidden] [ref=f6e157]: "560016"
                                - textbox [aria-hidden] [ref=f6e158]: "9999999999"
                            - generic [ref=f6e159]:
                              - heading "Shipping method" [level=2] [ref=f6e160]
                              - group "Choose a shipping method" [ref=f6e168]:
                                - group [ref=f6e170]:
                                  - generic [ref=f6e173]:
                                    - heading [level=3] [ref=f6e175]:
                                      - paragraph [ref=f6e176]:
                                        - strong [ref=f6e177]: International Shipping
                                    - strong [ref=f6e179]: £20.00
                      - region "Payment" [ref=f6e181]:
                        - group [ref=f6e185]:
                          - generic [ref=f6e186]:
                            - heading "Payment" [level=2] [ref=f6e189]
                            - paragraph [ref=f6e191]: All transactions are secure and encrypted.
                          - generic [ref=f6e193]:
                            - generic [ref=f6e194]:
                              - group [ref=f6e200]:
                                - generic [ref=f6e202]:
                                  - generic [ref=f6e203]:
                                    - heading [level=3] [ref=f6e205]:
                                      - strong [ref=f6e206]: Credit card
                                    - generic [ref=f6e207]:
                                      - status [ref=f6e208]
                                      - button "Test Payment Gateway" [ref=f6e211] [cursor=pointer]:
                                        - img "Test Payment Gateway" [ref=f6e213]
                                  - generic [ref=f6e220]:
                                    - generic [ref=f6e221]:
                                      - heading "Testing instruction" [level=4] [ref=f6e222]
                                      - generic [ref=f6e223]:
                                        - paragraph [ref=f6e224]: "Use these values to test your checkout:"
                                        - list [ref=f6e226]:
                                          - listitem [ref=f6e227]:
                                            - strong [ref=f6e228]: "1"
                                        ...
                                        - paragraph [ref=f6e233]: Use any future expiration date and any 3-digit security code.
                                      - link "Get support" [ref=f6e235]:
                                      ...
                                      - generic [ref=f6e248]:
                                        ...
                                        - generic [ref=f6e257]:
                                          ...
                                          - generic [ref=f6e258]:
                                            - iframe [ref=f6e260]:
                                              - generic [ref=f10e2]:
                                                ...
                                                - generic [ref=f10e13]:
                                                  ...
                                                  - textbox "Security code" [ref=f10e15]:
                                                    - /placeholder: ""
                                                    - text: "111"
                                            ...
                                            - button "More information about Security code" [ref=f6e262] [cursor=pointer]
                                      - generic [ref=f6e268]:
                                        - generic: Name on card
                                        - iframe [active] [ref=f6e271]:
                                          - generic [ref=f13e2]:
                                    ...
                                    - generic [ref=f6e274]:
                                      - checkbox "Use shipping address as billing address" [checked] [ref=f6e276] [cursor=pointer]
                                      - generic [ref=f6e277] [cursor=pointer]: Use shipping address as billing address
                              - textbox [aria-hidden] [ref=f6e279]
                            - button "Add discount" [ref=f6e280] [cursor=pointer]
                        - generic [ref=f6e287]:
                          - heading "Finalize order" [level=2] [ref=f6e288]
                          - button "Pay now" [ref=f6e292] [cursor=pointer]
                    - button [aria-hidden] [ref=f6e294] [cursor=pointer]: Submit
              - contentinfo [ref=f6e295]:
                - list [ref=f6e299]:
                  - listitem [ref=f6e300]:
                    - button "Terms of service" [ref=f6e301] [cursor=pointer]
            - complementary [ref=f6e304]:
              - generic [ref=f6e308]:
                - heading "Order summary" [level=2] [ref=f6e309]
                - generic [ref=f6e312]:
                  - region "Shopping cart" [ref=f6e313]:
                    - heading "Shopping cart" [level=3] [ref=f6e315]
                    - table "Shopping cart" [ref=f6e316]:
                      - rowgroup [ref=f6e317]:
                        - row "Product image Description Quantity Price":
                          - columnheader "Product image" [ref=f6e318]
                          - columnheader "Description" [ref=f6e319]
                          - columnheader "Quantity" [ref=f6e320]
                          - columnheader "Price" [ref=f6e321]
                      - rowgroup [ref=f6e322]:
                        - row "Quantity 1 Grey jacket Grey jacket 1 £55.00" [ref=f6e323]:
                          - cell "Quantity 1" [ref=f6e324]:
                            - generic [ref=f6e327]:
                              - generic [ref=f6e328]: Quantity
                              - text: "1"
                          - cell [ref=f6e329]:
                            - generic [ref=f6e330]:
                              - paragraph [ref=f6e331]: Grey jacket
                              - paragraph [ref=f6e333]: Grey jacket
                          - cell "1"
                          - cell "£55.00" [ref=f6e335]
                  - generic [aria-hidden]:
                    - generic: Scroll for more items
                - generic [ref=f6e340]:
                  - heading "Discount" [level=3] [ref=f6e341]
                  - generic [ref=f6e342]:
                    - generic [ref=f6e345]:
                      - generic [ref=f6e348]:
                        - generic [ref=f6e350]:
                          - generic: Discount code
                          - textbox "Discount code" [ref=f6e351]
                        - button "Apply Discount Code" [disabled]:
                          - generic: Apply
                      - button [aria-hidden] [ref=f6e353] [cursor=pointer]: Submit
                    - button "Back to finalize order" [ref=f6e354] [cursor=pointer]
                - generic [ref=f6e355]:
                  - heading "Cost summary" [level=3] [ref=f6e357]
                  - table "Cost summary" [ref=f6e358]:
                    - rowgroup [ref=f6e359]:
                      - row [ref=f6e360]:
                        - columnheader "Item" [ref=f6e361]
                        - columnheader "Value" [ref=f6e362]
                    - rowgroup [ref=f6e363]:
                      - row [ref=f6e364]:
                        - rowheader "Subtotal" [ref=f6e365]
                        - cell "£55.00" [ref=f6e366]
                      - row [ref=f6e367]:
                        - rowheader "Shipping" [ref=f6e368]
                        - cell "£20.00" [ref=f6e371]
                      - row [ref=f6e372]:
                        - rowheader [ref=f6e373]:
                          - strong [ref=f6e374]: Total
                        - cell "GBP £75.00" [ref=f6e375]:
                          - generic [ref=f6e376]:
                            - generic [ref=f6e377]: GBP
                            - strong [ref=f6e378]: £75.00
      - generic:
        - progressbar
  - generic [aria-hidden] [ref=f6e379]: Opens external website in a new window.
  - generic [aria-hidden] [ref=f6e380]: Opens in a new window.
  - generic [aria-hidden] [ref=f6e381]: Opens external website.
  - status [ref=f6e382]: "Updated total price: 75.00 British poundsPowered by GoogleUpdated shipping method: International Shipping"
  - alert [ref=f6e383]
```
